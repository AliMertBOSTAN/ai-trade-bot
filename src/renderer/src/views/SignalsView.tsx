...
const SignalCard = memo(
  function SignalCard({ s }: { s: TradeSignal }): JSX.Element {
  ...
  (a, b) => a.s.id === b.s.id && a.s.action === b.s.action && conf100(a.s) === conf100(b.s)
)

export default function SignalsView({ signals }: { signals: TradeSignal[] }): JSX.Element {
